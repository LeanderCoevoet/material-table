...
export default class MaterialTable extends React.Component {
  ...
  getProps(props) {
    ...
    calculatedProps.draggable = { ...MaterialTable.defaultProps.draggable, ...calculatedProps.draggable };
  ...
  renderTable = (props) => (
    <>
      ...
      <ConditionalWrapper
        condition={props.draggable.isDraggableHeaderActive}
        wrapperSuccess={children => {
          return (
            <Droppable droppableId={props.draggable.droppableHeaderId} direction="horizontal">
              {(provided, snapshot) => {
                return (
      ...
      <ConditionalWrapper
        ...
        wrapperSuccess={children => {
          return (
            <Droppable droppableId={props.draggable.droppableRowId} direction="vertical">
              {(provided, snapshot) => {
                return (
                  <div ref={provided.innerRef} {...provided.droppableProps}>
                    {children}
